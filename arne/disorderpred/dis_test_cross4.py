...
if __name__ == '__main__':
    ...
    if (ns.f =='pro'):
        if (ns.gcgenomic):
            models={"model_conv1d_100-test1234.sorted.GCgenomic-10-0.001_1_pro_GCgenomic_9.ann" :"DIScv/test5.sorted.GCgenomic",
                    "model_conv1d_100-test1235.sorted.GCgenomic-10-0.001_1_pro_GCgenomic_88.ann":"DIScv/test4.sorted.GCgenomic",
                    "model_conv1d_100-test1245.sorted.GCgenomic-10-0.001_1_pro_GCgenomic_89.ann":"DIScv/test3.sorted.GCgenomic",
                    "model_conv1d_100-test1345.sorted.GCgenomic-10-0.001_1_pro_GCgenomic_32.ann":"DIScv/test2.sorted.GCgenomic",
                    "model_conv1d_100-test2345.sorted.GCgenomic-10-0.001_1_pro_GCgenomic_41.ann":"DIScv/test1.sorted.GCgenomic"
            }
            if (ns.gc):
                models={"model_conv1d_100-test1234.sorted.GCgenomic-10-0.001_1_pro_GC_GCgenomic_15.ann":"DIScv/test5.sorted.GCgenomic",
                        "model_conv1d_100-test1235.sorted.GCgenomic-10-0.001_1_pro_GC_GCgenomic_79.ann":"DIScv/test4.sorted.GCgenomic",
                        "model_conv1d_100-test1245.sorted.GCgenomic-10-0.001_1_pro_GC_GCgenomic_28.ann":"DIScv/test3.sorted.GCgenomic",
                        "model_conv1d_100-test1345.sorted.GCgenomic-10-0.001_1_pro_GC_GCgenomic_84.ann":"DIScv/test2.sorted.GCgenomic",
                        "model_conv1d_100-test2345.sorted.GCgenomic-10-0.001_1_pro_GC_GCgenomic_40.ann":"DIScv/test1.sorted.GCgenomic"
                }
        elif (ns.gc):
            models={"model_conv1d_100-test1234.sorted.GCgenomic-10-0.001_1_pro_GC_78.ann":"DIScv/test5.sorted.GCgenomic",
                    "model_conv1d_100-test1235.sorted.GCgenomic-10-0.001_1_pro_GC_97.ann":"DIScv/test4.sorted.GCgenomic",
                    "model_conv1d_100-test1245.sorted.GCgenomic-10-0.001_1_pro_GC_4.ann":"DIScv/test3.sorted.GCgenomic",
                    "model_conv1d_100-test1345.sorted.GCgenomic-10-0.001_1_pro_GC_97.ann":"DIScv/test2.sorted.GCgenomic",
                    "model_conv1d_100-test2345.sorted.GCgenomic-10-0.001_1_pro_GC_72.ann":"DIScv/test1.sorted.GCgenomic"
            }
        else:

            models={"model_conv1d_100-test1234.sorted.GCgenomic-10-0.001_1_pro_70.ann":"DIScv/test5.sorted.GCgenomic",
                    "model_conv1d_100-test1235.sorted.GCgenomic-10-0.001_1_pro_92.ann":"DIScv/test4.sorted.GCgenomic",
                    "model_conv1d_100-test1245.sorted.GCgenomic-10-0.001_1_pro_73.ann":"DIScv/test3.sorted.GCgenomic",
                    "model_conv1d_100-test1345.sorted.GCgenomic-10-0.001_1_pro_86.ann":"DIScv/test2.sorted.GCgenomic",
                    "model_conv1d_100-test2345.sorted.GCgenomic-10-0.001_1_pro_3.ann":"DIScv/test1.sorted.GCgenomic" 
            }
    elif(ns.f=='rna'):
        if (ns.gcgenomic):
            models={
    ...
    with open('predictions/outpred-conv1d'+field+'.roc','w',newline="") as f:
        w = csv.writer(f)
        w.writerows(rockeys)
        TP=np.sum(positive)
        FP=np.sum(negative)
