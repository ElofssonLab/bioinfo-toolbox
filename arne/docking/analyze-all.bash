...
do
	...
	then
		...
		then
		    ...
		    $bin/ppv-contact.py  seq/$1.fa seq/$2.fa pdb_chains/$1.pdb.pdb-Bvalue.pdb tm-chains/$2.pdb.pdb-Bvalue.pdb seq/$1-$2.${ali}.${dca} --print_dist --outfile out/$1-$2.${ali}.${dca}.dist > out/$1-$2.${ali}.${dca}.out
		fi
	    fi
	fi
    done
