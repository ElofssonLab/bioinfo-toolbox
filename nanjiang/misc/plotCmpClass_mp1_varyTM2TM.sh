...
plot \
    '$dataFile' using 4:xtic(2)   title 'IDT' ls 1 , \
    ''          using 5:xtic(2)   title 'INV' ls 2, \
    ''          using 6:xtic(2)   title 'Only TM2GAP' ls 3, \
    ''          using 7:xtic(2)   title 'Only TM2SEQ' ls 4, \
    ''          using 8:xtic(2)   title 'Both TM2GAP and TM2SEQ' ls 5
