...
MakePlot2() { #{{{ # using lines points, dashed line, black and white, 
    ...
    case $mode in 
        0|1|2|3|4|5)
            ...
            ((col1=addon+1))
            ((col2=addon+2))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'N-terminal' ls 1"
            ((col1=addon+3))
            ((col2=addon+4))
            plotOption="$plotOption, '' using $col2:xtic($col1) ti 'Internal' ls 2"
            ((col1=addon+5))
            ((col2=addon+6))
            plotOption="$plotOption, '' using $col2:xtic($col1) ti 'C-terminal' ls 3"
            b1=$b1.$mode
            ;;
        0-all)
            m=0
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'TM2GAP in Only TM2GAP' ls 0"
            b1=$b1.$mode
            ;;
        1-all)
            m=1
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'TM2GAP in Both TM2GAP_AND_TM2SEQ' ls 1"
            b1=$b1.$mode
            ;;
        4-all)
            m=4
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'TM2GAP' ls 4"
            b1=$b1.$mode
            ;;
        5-all)
            m=5
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'TM2SEQ' ls 5"
            b1=$b1.$mode
            ;;
        01-all)
            m=0
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="$plotOption, '' using $col2:xtic($col1) ti 'TM2GAP in Both TM2GAP_and_TM2SEQ' ls 1"
            b1=$b1.$mode
            ;;
        45-all)
            m=4
            ...
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="'$dataFile' using $col2:xtic($col1) ti 'all TM2GAP' ls 4"
            m=5
            ((addon=m*8))
            ((col1=addon+7))
            ((col2=addon+8))
            plotOption="$plotOption, '' using $col2:xtic($col1) ti 'all TM2SEQ' ls 5"
            b1=$b1.$mode
            ;;
        *)return 1
            ;;
