...
set style line 5 lt 2 lw 1 lc rgb "grey20"
set style line 6 lt 2 lw 1 lc rgb "purple"
...
plot \
    '$datafile1' using (\$3/${scale1[2]}):xtic(2)   title 'TM2TM, Topcons' ls 1, \
    '$datafile2' using (\$3/${scale2[2]}):xtic(2)   title 'TM2TM, Topcons_single' ls 4
...
plot \
    '$datafile1' using (\$4/${scale1[3]}):xtic(2)   title 'TM2GAP, Topcons' ls 2, \
    '$datafile1' using (\$5/${scale1[4]}):xtic(2)   title 'TM2SEQ, Topcons' ls 3, \
    '$datafile2' using (\$4/${scale2[3]}):xtic(2)   title 'TM2GAP, Topcons_single' ls 5,\
    '$datafile2' using (\$5/${scale2[4]}):xtic(2)   title 'TM2SEQ, Topcons_single' ls 6
unset multiplot
EOF
