...
Created 2015-04-27, updated 2015-04-27, Nanjiang Shu 
"""%(progname)
BLOCK_SIZE=100000
...
#     print
    ...
    record['anno'] = ""
    record['rlty'] = -1
    topoNameList =  ['predtopo_TOPCONS2', 'predtopo_OCTOPUS',
...
# 1 for identical, 0 for non identical and -1 for empty topology
                    (matchList, numIDTtopo, numPredictor) = lcmp.MatchTopology(
                            record['predtopo_TOPCONS2'], topoList,
                    ...
                    if record['predtopo_TOPCONS2'].find('M')>=0:
                        ...
                        if record['predtopo_TOPCONS2'].find('S')>=0:
                            ...
                            top = record['predtopo_TOPCONS2'].replace('S', iostat)
                        else:
