...
plot \
    '$datafile1' using (\$6/${scale1[5]}):(\$3/${scale1[2]}) title 'TM2TM, Topcons' ls 1, \
    '$datafile1' using (\$6/${scale1[5]}):(\$4/${scale1[3]}) title 'TM2GAP, Topcons' ls 2, \
    '$datafile1' using (\$6/${scale1[5]}):(\$5/${scale1[4]}) title 'TM2SEQ, Topcons' ls 3, \
    '$datafile2' using (\$6/${scale2[5]}):(\$3/${scale2[2]}) title 'TM2TM, Topcons_single' ls 4, \
    '$datafile2' using (\$6/${scale2[5]}):(\$4/${scale2[3]}) title 'TM2GAP, Topcons_single' ls 5, \
    '$datafile2' using (\$6/${scale2[5]}):(\$5/${scale2[4]}) title 'TM2SEQ, Topcons_single' ls 6
EOF
