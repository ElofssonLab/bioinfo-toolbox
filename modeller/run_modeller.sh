...
TEMPL_ID=$3
TEMPL_PDB=$4
/home/x_mirmi/bin/modeller9.12/bin/modpy.sh python /home/x_mirmi/bioinfo-toolbox/modeller/align_to_template.py ${ID} ${SEQFILE} ${TEMPL_ID} ${TEMPL_PDB} ${ID}_${TEMPL_ID}.ali
